...
export default {
        ...
        if (self.page_num < self.list_total) {
          ...
          axios({
            ...
            for (var i = 0; i < length; i++) {
              ...
              var obj = "<li style='padding: 0.8rem 0.5rem;border: 1px solid #cdcdcd;margin: 0 21px 10px;list-style-type: none;'>" + "<span class='name'>" + name + "</span>" + "<span style='padding: 0 0.5rem;'>|</span>" + "<span class='time'>" +
                time + "</span>" + "<span class='floor' style='background-color: #CDCDCD;float: right;padding: 0.1rem 0.5rem;border-radius: 15%;'>" + floor + "#" + "</span>" + "</br>" +
                "<span class='content' style='padding-top: 0.5rem;display: inline-block;'>" + content + "</span>" + "</li>"
              if (msg_id > flag) {
    ...
    if (this.author == '') {
      ...
      axios({
        ...
        for (var i = 0; i < length; i++) {
          ...
          var msg_id = response.data[i].msg_id;
          var floor = $('.reward_list').eq(msg_id - 1).children().length + 1;
          var obj = "<li style='padding: 0.8rem 0.5rem;border: 1px solid #cdcdcd;margin: 0 0.7rem 0.5rem;list-style-type: none;'>" + "<span class='name'>" + name + "</span>" + "<span style='padding: 0 0.5rem;'>|</span>" + "<span class='time'>" +
            time + "</span>" + "<span class='floor' style='background-color: #CDCDCD;float: right;padding: 0.1rem 0.5rem;border-radius: 15%;'>" + floor + "#" + "</span>" + "</br>" +
            "<span class='content' style='padding-top: 0.5rem;display: inline-block;'>" + content + "</span>" + "</li>"
          $('.reward_list').eq(msg_id - 1).append(obj);
        }
  ...
  methods: {
    ...
    comment: function(index) {
      ...
      var obj = "<li style='padding: 0.8rem 0.5rem;border: 1px solid #cdcdcd;margin: 0 0.7rem 0.5rem;list-style-type: none;'>" + "<span class='name'>" + name + "</span>" + "<span style='padding: 0 0.5rem;'>|</span>" + "<span class='time'>" + time +
        "</span>" + "<span class='floor' style='background-color: #CDCDCD;float: right;padding: 0.1rem 0.5rem;border-radius: 15%;'>" + floor + "#" + "</span>" + "</br>" + "<span class='content' style='padding-top: 0.5rem;display: inline-block;'>" +
        content + "</span>" + "</li>"
      axios({
        method: 'post',
